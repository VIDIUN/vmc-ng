...
GITHUB_REPO_DOWNLOADS=https://github.com/vidiun/vmc-ng/releases/download/
GITHUB_FILE_PREFIX=vmc-ng-
USAGE="Usage: script for changing vmc-ng version; to run execute: ./get-app v<version>"
VERSION=
