var en = {
    ...
    "telephone": "Telephone",
    "comments": "Comments",
    "upgrade": "Need more VMC users? <a href='{0}' target='_blank'><u><font color='#009acc'>Click here</font></u></a> to upgrade your account.",
    "downgrade": "Downgrade",
    "send": "Send",
    "dollarSign": "$",
    ...
    "describeList": "Integrator/Web developer,Ad Agency,Vidiun Plugin/Extension/Module Distributor,Social Network,Personal Site,Corporate Site,E-Commerce,E-Learning,Media Company/Producer",
    ...
    "entitlementsNote": "<B>Note:</B> The Privacy Context Label of each category defined here, will be automatically applied to its sub categories. The same label should be set as part of the application's session (VS) privileges. <font color='#009acc'><u><a href='event:helpEntitlement'>Read More</a></u></font>",
    ...
    "setEntNote": "Entitlement settings will be added to all sub-categories in an asynchronous process. This operation may take a few minutes.\\n\\nNote: This action may impact access to content in the {0} category through existing applications that were not updated to work with the Vidiun entitlement services.\\n\\nAre you sure you want to continue?",
    ...
    "vidiunDirectoryColumnTitle": "Vidiun Directory",
    ...
    "transcodingSettingsAdvancedModeLiveIntroText": "Here you can define or set a default live transcode profile. Live transcode profiles are available for your \"vidiun streaming\" live broadcasts.",
    ...
    "convertToFlavor": "Use Vidiun Transcoding:",
    ...
    "gen_no_force": "Use Vidiun's Optimization",
    ...
    "metadataMalformedXSDError": "There is an error with your metadata structure. Please contact Vidiun support for assistance",
    ...
    "metadataCustomProfileAlert": "Custom metadata definitions were tailor made for this account by the Vidiun professional services team.<br>If you wish to update the metadata definitions, add or update fields,  please  <a href='http://www.vidiun.com/index.php/vmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Vidiun support</font></a>.",
    ...
    "deleteSchema": "Delete",
    "customSchemaMessage": "* Data Schema was manually set up by Vidiun Professional Services. Please reach out to Account manager for updates / changes.",
    ...
    "user_change_pwd": "Change VMC Password",
    "user_edit": "Edit",
    "forbidden_error_title": "Permission Error",
    "forbidden_error": "An unexpected permission error has occurred. Browser page refresh is recommended. When error is persistent, please contact Vidiun Support for additional information.",
    "users_tab": "Users",
    "roles_tab": "Roles",
    "usersPageDesc": "Here you can manage the VMC users with various levels of access to your account. You can add new users, edit permissions for existing users and more.",
    "authorized_users": "Authorized VMC Users",
    "add_user": "Add User",
    "users_quota": "Current status: {0} VMC {1} in use. {2} additional available.",
    ...
    "user_changes": "* Changes made to the user's role may impact his/her current VMC session.",
    "add_role": "Add Role",
    ...
    "user_exists_other_partner": "{0} is already listed in the system and is associated with another VMC account. \\nDo you want to associate this user with this account as well?",
    "user_exists_current_partner": "User with Id {0} already exists on the account. Do you want to enable VMC access to this user?",
    ...
    "roles_page_description": "Here you can define different roles with specific permissions to the VMC functionalities. You can then assign these roles to each VMC user accordingly.",
    "save_date": "Save Date",
    "duplicate": "Duplicate",
    ...
    "role_changes": "* Changes made to an active role may impact users' current VMC sessions.",
    ...
    "disabled_options": "<u><a href=\"event:http://site.vidiun.com/Request-Users.html\">Contact us</a></u> to learn more about adding any disabled items below to your account.",
    ...
    "count_adminToolTip": "Number of media entries contributed by users of type Admin, this includes all uploads via VMC",
    ...
    "vdpLayoutError": "Player Can't be loaded. This error is most likely caused by bad data provided in \"additional parameters\" and can be fixed by editing the player configuration file. Contact support for help.",
    ...
    "forbiddenError": "An unexpected permission error has occurred. Browser page refresh is recommended. When error is persistent, please contact Vidiun Support for additional information.\\n{0}ad=Andorra",
    ...
    "relatedInfo": "You can attach files (documents, media) to your entries. Uploaded files will not create new entries but will receive a unique Vidiun ID.",
    ...
    "destintaionError": "An error has occurred, please re-check the data you submitted or <a href='http://www.vidiun.com/index.php/vmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Vidiun support</font></a>.",
    "vidiunError": "An error has occurred. Please <a href='http://www.vidiun.com/index.php/vmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Vidiun support</font></a>.",
    ...
    "dfErrAddBulk": "Failed to create bulk upload job in Vidiun.",
    "dfErrBulkUpload": "Failed to execute the bulk upload job in Vidiun.",
    ...
    "dfErrUpdateFile": "Failed to update the drop folder file record in Vidiun.",
    ...
    "dfErrDnldFile": "Failed in file transferring from the drop folder to Vidiun.",
    "dfErrDelFile": "Physical file deletion failed.",
    "megaBytes": "MB",
    "transferringDesc": "File is currently uploading to the drop folder",
    "downloadingDesc": "The file is currently importing from the drop folder to Vidiun",
    ...
    "errDnldDesc": "Failed to import the file from the drop folder to Vidiun",
    "dfUploadStart": "Upload start detected on: {0}",
    "dfUploadEnd": "Upload completion detected on: {0}",
    "dfTranserStart": "File transfer from drop folder to Vidiun started on: {0}",
    "dfTransferEnd": "File transfer of drop folder to Vidiun ended on: {0}",
    ...
    "dfUpsale": "The drop folder capability allows you to easily trigger content ingestion by dropping files into a folder in your environment. To enable this capability for your account, <u><a href='http://corp.vidiun.com/about/contact' target='_blank'>contact us</a></u><br><u><a href='http://knowledge.vidiun.com/vidiun-drop-folders-service-content-ingestion-0' target='_blank'>Learn more about drop folders</a></u>",
    ...
    "ipdefault": "By default we use your public IP accessing this VMC.",
    ...
    "vidiunLiveEntryCreatedMessage": "Live Stream Entry has been created successfully. \\nDo you want to view entry details?",
    ...
    "enableDvr": "Enable Live DVR (seeking to early parts of the live stream). DVR window is 30 minutes by default, you can contact Vidiun to adjust this.",
    "enableDvrVidiun": "Enable Live DVR (seeking to early parts of the live stream). DVR window is 2 hours by default.",
    ...
    "forgotPasswordText": "Instructions to reset your password will be sent to your email. if you forgot which email you used, please <a href='http://corp.vidiun.com/about/contact'><u>contact us</u></a>.",
    ...
    "welcome": "Welcome to Vidiun, please select your password.",
    "pleaseLogin": "Your new password has been set, please login to Vidiun management console.",
    ...
    "ADMIN_VUSER_NOT_FOUND": "The username or password you have entered is incorrect.",
    ...
    "LOGIN_BLOCKED": "Login denied. You have exceeded the number of invalid login attempts. You can contact Vidiun support at support@vidiun.com to unblock your account.",
    "LOGIN_RETRIES_EXCEEDED": "Your account has been locked, and will not be available for 24 hours. You can contact Vidiun support at support@vidiun.com to unblock your account.",
    ...
    "ADMIN_VUSER_WRONG_OLD_PASSWORD": "old password is wrong",
    "INVALID_FIELD_VALUE": "value in field {0} is not valid",
    "noEmail": "This email",
    "successMsg": "Thank you for signing up. An email with further instructions has been sent to the email address you provided. If you do not receive an email within a few minutes, please contact support@vidiun.com.",
    "signUp": "Sign Up",
    ...
    "usageDescription": "Please describe how you plan to use Vidiuns video platform",
    ...
    "VIDIUN": "Vidiun",
    "VIDIUN_USER_CLIPS": "Vidiun User Clips",
    ...
    "secVSCheckBoxBtn": "Secure viewing of this video with server side secret (VS)",
    "secVSDescription": "Provides a higher level of security, relevant for pay-per-view models and premium content",
    ...
    "domainExampleLabel": "For example: vidiun.com",
    "domainLabel": "Domain:",
    "saveBtn": "Save",
    "cancelBtn": "Cancel",
    ...
    "entriesNotIncludedMsg": "<b>Note:</b> {NUM} entries will not be included in the feed, since they are not transcoded in the required {RQUIRED_FLAVOR_NAME} flavor.<br>You can transcode any entry to {RQUIRED_FLAVOR_NAME}  by going to the Manage section of the VMC, then open the specific entry that you would like to transcode, go to the Flavors tab, and select the \"Convert\" option.<br>If you wish to transcode multiple entries into {RQUIRED_FLAVOR_NAME}, please contact Vidiun professional services: <font color='#03c6f7'><u><a href='event:http://corp.vidiun.com/support/form/project/13?project=Vidiun%20Management%20Console&custom_field_16={PARTNER_ID}&custom_field_7={EMAIL}&custom_field_5={SCREEN_NAME}'>http://corp.vidiun.com/support/form/project/13</a></u></font>",
    ...
    "tmAdvise1": "Vidiun and TubeMogul have partnered to provide a premium syndication service at the most attractive pricing available.",
    ...
    "tmAdvise4WithLink": "To learn more about this feature and pricing information contact our sales team via the upgrade form <font color='#03c6f7'><b><u><a href='event:http://corp.vidiun.com/about/contact'>http://corp.vidiun.com/about/contact</a></u></b></font> or call +1 800 871 5224.",
    "tmAdvise5": "If you already have a Vidiun-TubeMogul account submit this feed to TubeMogul by following these steps:",
    "tmAdvise6": "Copy the feed URL",
    "tmAdvise7": "Login to your Vidiun-TubeMogul account",
    "tmAdvise8": "In your Vidiun-TubeMogul account go to Advanced Tools> More Tools and select  \"MRSS Feed Manager\"",
    ...
    "integrationPrivacyKeyTooltip": "In order to enable access to content in this category from the appllication and enforce its entitlement rules, the privacy context label MUST be set as part of the application session (VS) privileges. \\n\\nThis label is set as part of the MediaSpace installation/upgrade process. For any other purposes set/edit the context label from the Integration Settings page under the Settings tab.",
    ...
    "importSourceForLink": "<b>Note:</b> When conversion by Vidiun is required, the file defined as Source will be imported to Vidiun.",
    ...
    "importFromExistingHostingText": "This list shows completed and in-progress bulk upload jobs for this VMC account.",
